...
#### 1.3.5. *Генерация map-файлов сторонними инструментами*
...
#### 1.3.6. Перенос прототипа объекта оценки в образ ВМ
...
#### 1.3.7. Тестирование виртуализированной среды функционирования ОО
...
В случае установки в формате бинарного комплекта следует скачать его по [ссылке](#1.1.1.-Комплект-поставки) и распаковать.
