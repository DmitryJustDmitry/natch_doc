...
Через 2-3 минуты процесс завершится успешно (нюанс - в моем случае при запуске qemu внутри виртуальной машины VBox периодически отмечается подвисание GUI хостовой ОС. Лечится в частности минимизацией/максимизацией окна виртуальной машины VBox):
