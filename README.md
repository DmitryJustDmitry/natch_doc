...
- бинарный дистрибутив, требующий наличие аппаратного ключа с лицензией (персональны "черный" ключ, сетевой "красный" ключ или иные версии ключа):

[Natch v.1.3.1 (виртуальная машина в формате ova)](https://nextcloud.ispras.ru/index.php/s/learning)

- образ Ubuntu 20 для VirtualBox с предустановленным защищенным Natch 1.3.1, необходимым ПО (pip3, vim) и доступом к VPN-серверу, 
раздающему лицензии
