...
**Важное замечание - начиная с версии Natch v1.3 инструмент умеет самостоятельно доставать информацию об отладочных символах из исполняемых файлов, собранных с сохранением отладочной информации (ключ компилятора -g), как минимум для компиляторов gcc и clang. Тем не менее следующие два раздела оставлены в качестве пособия в т.ч. для случаев, когда возможность сборки исполняемого файла отсутствует.**
