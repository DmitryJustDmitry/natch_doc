...
Передём в каталог wget2/src, где собственно и лежит пресобранная версия wget2, и подготовим в консоли строку запуска wget2 (у вас она может быть иной, лишь бы была корректной и обращалась к внешнему ресурсу). 
...
Нажмем `Ctrl (в моём случае левый) + Alt + G`, выйдем в монитор qemu и выполним команду генерации снепшота (займёт около 1 минуты):
